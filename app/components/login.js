...
function LogIn() {
  ...
  return (
    <>
      <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 px-6 dark:bg-black">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md dark:bg-gray-800 w-full max-w-sm p-6 rounded-lg shadow-md">
